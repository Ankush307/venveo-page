                    ...
                    <div className='xl:w-8/12 max-md:hidden max-lg:w-full flex xl:gap-[83px] max-md:gap-5 max-lg:flex-wrap max-sm:justify-center max-sm:items-center'>
                        {FOOTER_LIST.map((obj, i) => (
                            <div key={i} className='w-3/12 max-lg:w-full max-w-[168px] mx-auto flex-wrap'>
                                ...
                                <ul className='pt-5'>
                                    <li className=''><a href="/" className='text-white font-light text-[15px] font-maisonLight leading-[30px]'>{obj.list}</a></li>
                                    <li className=''><a href="/" className='text-white font-light text-[15px] font-maisonLight leading-[30px]'>{obj.listTwo}</a></li>
                                    <li className=''><a href="/" className='text-white font-light text-[15px] font-maisonLight leading-[30px]'>{obj.listThree}</a></li>
                                    <li className=''><a href="/" className='text-white font-light text-[15px] font-maisonLight leading-[30px]'>{obj.listFour}</a></li>
                                    <li className=''><a href="/" className='text-white font-light text-[15px] font-maisonLight leading-[30px]'>{obj.listFive}</a></li>
                                </ul>
                            </div>
                        ))}
                    </div>
                        ...
                        {FOOTER_SM_VIEW_LIST.map((obj, i) => (
                            <div key={i} className='w-3/12 max-lg:w-full'>
                                ...
                                <ul className={`overflow-hidden duration-300 ease-linear flex flex-col gap-6 ${mobileView === i ? "max-h-[300px] pt-5" : "max-h-0"}`}>
                                    <li className='flex gap-4 items-center'>{obj.icon}<a href="/" className='text-white font-light font-maisonLight text-[15px] leading-[30px] hover:text-lightGreen duration-300 ease-linear'>{obj.list}</a></li>
                                    <li className='flex gap-4 items-center'>{obj.iconTwo}<a href="/" className='text-white font-light font-maisonLight text-[15px] leading-[30px] hover:text-lightGreen duration-300 ease-linear'>{obj.listTwo}</a></li>
                                    <li className='flex gap-4 items-center'>{obj.iconThree}<a href="/" className='text-white font-light font-maisonLight text-[15px] leading-[30px] hover:text-lightGreen duration-300 ease-linear'>{obj.listThree}</a></li>
                                    <li className='flex gap-4 items-center'>{obj.iconFour}<a href="/" className='text-white font-light font-maisonLight text-[15px] leading-[30px] hover:text-lightGreen duration-300 ease-linear'>{obj.listFour}</a></li>
                                    <li className='flex gap-4 items-center'>{obj.iconFive}<a href="/" className='text-white font-light font-maisonLight text-[15px] leading-[30px] hover:text-lightGreen duration-300 ease-linear'>{obj.listFive}</a></li>
                                </ul>
                            </div>
                        ))}
                    </div>
