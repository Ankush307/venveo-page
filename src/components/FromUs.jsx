  ...
  return (
    <div>
      ...
      <div className="container mx-auto max-w-[1320px] ">
        ...
        <p className='text-[15px] font-maisonRegular font-normal leading-[20px] pt-[13px] mb-9 text-center'>Digital marketing resources from Venveo to help you grow.</p>
        <button className='flex mb-[81px] font-maisonMedium font-semibold items-center justify-center gap-[11px] max-w-[78px] mx-auto '>See All <img src="./assets/image/svg/next-btn.svg" alt="btn img" /> </button>
