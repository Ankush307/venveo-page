            ...
            <div className="container mx-auto max-w-[1140px] px-5">
                <div className="flex flex-wrap relative">
                    <div className="md:w-1/2 w-full">
                        <p className='text-[15px] font-normal'>Get a free competitive analysis on your market</p>
                        <h3 className='lg:text-[40px] md:text-4xl text-3xl max-sm:max-w-[200px] max-sm:mb-16 font-light leading-[100%] mb-8 '>Outsmart your competition</h3>
                    </div>
                    <div className="md:w-1/2 w-full">
