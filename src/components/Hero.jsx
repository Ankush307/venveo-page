  ...
  return (
    <div className='bg-pine-green xl:min-h-[1103px] overflow-hidden relative'>
      ...
      <div className="container mx-auto relative px-4">
        <h1 className='lg:text-[120px] md:text-8xl sm:text-7xl text-6xl font-bold max-w-[620px] text-center mx-auto text-white  font-sohneschmal leading-[86%] uppercase sm:pt-10 pt-12'>Make marketing A growth machine <span> <img className='ml-9 max-sm:max-w-[173px] pointer-events-none' src="./assets/image/png/single-line.png" alt="" /></span></h1>
        <p className='text-white font-light sm:text-2xl text-[22px] sm:leading-[30px] leading-[28px] text-center max-w-[656px] mx-auto font-maisonneuelight mb-6 pt-[5px] '>We focus on results. Not just chatter. Elevate your business with our top-tier services and tech. Get a proposal now.</p>
