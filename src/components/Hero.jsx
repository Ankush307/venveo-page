  ...
  return (
    <div className='bg-pine-green xl:min-h-[1103px] overflow-hidden'>
      ...
      <div className="container mx-auto relative px-4">
        <h1 className='lg:text-[120px] md:text-8xl sm:text-7xl text-6xl font-bold max-w-[620px] text-center mx-auto text-white  font-sohneschmal leading-[86%] uppercase sm:pt-20 pt-12  mb-6'>Make marketing A growth machine</h1>
        ...
        <img className='absolute top-[135%] right-[-7%] max-xl:hidden' src="./assets/image/webp/hero-bg-layer.webp" alt="top layer" />
      </div>
      <div className="hero-section px-4 z-10">
        <div className="relative">
          <img src="./assets/image/png/made-for-brands.png" alt="made-for-brands" className='md:h-[107px] max-sm:h-[90px] lg:left-[1%] xl:left-[15%] absolute md:left-[70%] lg:bottom-[12%] md:bottom-1 max-sm:-bottom-0 max-sm:left-[62%]' />
