...
const PartnersGrowth = () => {
                ...
                <div className='bg-cover bg-no-repeat bg-center lg:bg-tabOneBgImg max-lg:bg-tabOneSmImg w-full max-w-[1280px] max-lg:h-full h-[720px] mx-auto'>
                    <div className='sm:pt-[75px] pt-14 sm:px-6 px-4 gap-4 flex items-center justify-between'>
                        <div>
                            ...
                            <button className='max-lg:mb-6 max-sm:w-[334px] h-[84px] w-[250px] max-sm:mx-auto justify-center text-white font-medium font-maisonMedium text-customsm flex items-center border border-solid bg-[#FF4242] border-[#FF4242] gap-[10px] mt-[58px]'><NetWorkIcon /> Subscribe to Podcast <span className='text-[6px]'>▼</span></button>
                        </div>
            ...
            return (
                <div className='lg:bg-tabThreeBgImg max-lg:bg-tabThreeSmImg max-lg:h-full bg-cover bg-center bg-no-repeat w-full max-w-[1337px] h-[720px] mx-auto'>
                    <div className='pt-[75px] ps-[79px] max-lg:p-12 max-md:p-8 max-sm:p-5'>
                        ...
                        <button className='max-lg:mb-6 mt-[57px] transition-all duration-300 ease-linear  right-button flex items-center text-black text-[15px] font-semibold font-maisonMedium leading-[15px] py-[31px] gap-[10px] px-[28px] bg-lemon-lime hover:bg-black hover:text-white'>Call to Action Somewhere <ArrowIcon /> </button>
                        <div>
    ...
    return (
        <div className='lg:pt-[113px] md:pt-20 sm:pt-16 pt-12 pb-[60px] max'>
            <h3 className='lg:text-[80px] md:text-7xl text-6xl font-sohne uppercase leading-[87%] text-center max-w-[500px] mx-auto'>The growth partner </h3>
            <p className='md:text-[30px] text-2xl font-maisonLight text-center pb-1'>you’ve been looking for.</p>
            <p className='mt-[43px] font-normal text-[15px] text-black leading-[20px] font-maisonRegular text-center'>Businesses trust Venveo to power grow.</p>
            <div className='tabs-parent mt-[105px] max-xl:mt-16 max-lg:mt-10 max-md:mt-8 relative z-20'>
                <div className='relative max-md:mx-auto max-md:gap-7 flex items-center justify-center gap-[78px]'>
                    <p className={`text-lg max-sm:text-base font-semibold  text-black opacity-35 leading-[18px] font-maisonMedium cursor-pointer ${activeTab === 1 ? 'text-black !opacity-100' : ''}`}
                    ...
                    <p className={`text-lg max-sm:text-base font-semibold text-black opacity-35 leading-[18px] font-maisonMedium cursor-pointer ${activeTab === 2 ? 'text-black !opacity-100' : ''}`}
                    ...
                    <p className={`text-lg max-sm:text-base font-semibold text-black opacity-35 leading-[18px] font-maisonMedium cursor-pointer ${activeTab === 3 ? 'text-black !opacity-100' : ''}`}
